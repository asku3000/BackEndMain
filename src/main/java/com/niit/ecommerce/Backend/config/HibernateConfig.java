...
@Configuration
@ComponentScan(basePackages = { "com.niit.ecommerce.Backend" })
...
public class HibernateConfig {
	...
	private final static String DATABASE_URL = "jdbc:h2:tcp://localhost/~/backend";
	private final static String DATABASE_DRIVER = "org.h2.Driver";
	private final static String DATABASE_DIALECTS = "org.hibernate.dialect.H2Dialect";
	private final static String DATABASE_USERNAME = "asku";
	private final static String DATABASE_PASSWORD = "7838463655";
	...
	public SessionFactory getSessionFactory(DataSource datasource) {
		...
		builder.scanPackages("com.niit.ecommerce.Backend.entity");
